...
int main() {
	...
	LPCWSTR OS03_02_1 = L"OS03_02_1.exe";
	LPCWSTR OS03_02_2 = L"OS03_02_2.exe";
	...
	if (CreateProcess(
		...
		cout << "[OK] Процесс OS03_02_1 был создан." << endl;
	else cout << "[Ошибка] Процесс OS03_02_1 не удалось создать." << endl;


	if (CreateProcess(OS03_02_2, NULL, NULL, NULL, FALSE, CREATE_NEW_CONSOLE, NULL, NULL, &si2, &pi2))
		cout << "[OK] Процесс OS03_02_2 был создан." << endl << endl;
	else cout << "[Ошибка] Процесс OS03_02_2 не удалось создать." << endl << endl;
